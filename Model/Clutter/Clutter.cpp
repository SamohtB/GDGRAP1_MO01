...
void Clutter::Initialize(std::string strMesh, std::string strTex, std::string strVert, std::string strFrag)
{
...
void Clutter::Draw(CameraData cameraData, LightData pointLight, LightData directionalLight)
{
    glUseProgram(this->shader->GetShaderProgram());
...
Transform* Clutter::GetTransform()
{
